    ...
    <div class="container-fluid" style="background-color: #8F3797; color:#fff">
        <footer class="row row-cols-1 row-cols-sm-2 row-cols-md-5 py-5 my-5 border-top">
            ...
            <div class="col-lg-3">
                <h5>Media Sosial</h5>
                <ul class="nav flex-column">
                    <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-white">Web Gunadarma</a></li>
                    <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-white">eJournal</a></li>
                    <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-white">BAAK</a></li>
                    <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-white">Pengabdian Masyarakat</a></li>
                </ul>
            </div>
        </footer>
    </div>
